...
const LOCALE_TH = {
    ...
    "consent.intro": "ก่อนใช้งาน Thai TM30 Helper กรุณาอ่านและยอมรับข้อกำหนดต่อไปนี้:",
    "consent.point1.title": "คุณคือผู้ควบคุมข้อมูล",
    "consent.point1.text": "ข้อมูลส่วนบุคคลทั้งหมดที่คุณกรอกจะถูกจัดเก็บในเครื่องของคุณ คุณมีความรับผิดชอบในการประมวลผลข้อมูลนี้อย่างถูกกฎหมายภายใต้ PDPA และกฎหมายที่เกี่ยวข้อง",
    "consent.point2.title": "ความรับผิดชอบของคุณ",
    "consent.point2.text": "คุณต้องมีฐานทางกฎหมายที่ถูกต้อง (เช่น ความยินยอม) สำหรับการประมวลผลข้อมูลส่วนบุคคลของแขก ผู้เช่า หรือบุคคลที่สาม",
    "consent.point3.title": "ข้อจำกัดความรับผิดชอบของนักพัฒนา",
    "consent.point3.text": "นักพัฒนาไม่เก็บรวบรวม จัดเก็บ หรือมีสิทธิ์เข้าถึงข้อมูลใดๆ ที่คุณกรอก นักพัฒนาไม่รับผิดชอบต่อการใช้งานที่ไม่เหมาะสมหรือการละเมิด PDPA",
    "consent.footer": "การคลิก \"ยอมรับ\" หมายความว่าคุณได้อ่าน เข้าใจ และยอมรับข้อกำหนดเหล่านี้",
